<template>
  <div class="bankcard-verification">
    ...
    <group :title="reminder">
      <x-input v-for="(item, index) of info" :key="index"
               :title="item.title"
    ...
    <div class="btn-container">
      <x-button class="bind-btn" @click.native="addCardVerify" v-if="fromMyBankcard">确认绑定1</x-button>
      <x-button class="bind-btn" @click.native="accountOpen" v-else>确认绑定2</x-button>
    </div>
